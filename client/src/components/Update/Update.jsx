...
<form className="row createForm" onSubmit={formHandler} style={{backgroundColor:"gray"}}>
  ...
  <div className="heading text-center">
    <h3 style={{color:"white"}}>Create Learner</h3>
  </div>
            <div className="col-md-3">
              
              <input type="text" value={learnerId} className="form-control text-center" placeholder='Learner Id' onChange={(e)=>setlearnerId(e.target.value)} />
            </div>
            <div className="col-md-5">
              
              <input type="text" value={learnerName} className="form-control text-center" placeholder='Learner Name' onChange={(e)=>setlearnerName(e.target.value)} />
            </div>
          ...
          <div className="row">
            <div className="col-md-2">
              ...
              <select value={course}  className="form-select text-center" onChange={(e)=>setCourse(e.target.value)} >
             ...
             <div className="col-md-3">
              ...
              <select  value={batch} className="form-select text-center" onChange={(e)=>setBatch(e.target.value)} >
             ...
             <div className="col-md-3">
              ...
              <select value={project}  className="form-select text-center"  onChange={(e)=>setProject(e.target.value)} >
            ...
            <div className="row">
              <div className="col-md-3">
                <select name="" value={courseStatus}  className='form-select' onChange={(e)=>setcourseStatus(e.target.value)}>
              ...
              <div className="col-md-3">
                <select name="" value={placementStatus} className='form-select' onChange={(e)=>setplacementStatus(e.target.value)}>
            ...
            <div className="col-md-3" >
              ...
              <button type='submit' className="btn  form-control btnn " style={{backgroundColor:"brown",color:"white"}}>Submit</button>
            </div>
        </form>
